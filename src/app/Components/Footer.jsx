  ...
  <footer className="py-12 px-4 relative overflow-hidden" style={{ borderTop: "1px solid rgba(201,168,76,0.15)", background: "#050000" }}>
    <div className="max-w-6xl mx-auto relative z-10">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-8">
        ...
        <Link href="/" className="flex items-center gap-2 group">
          <div className="w-8 h-8 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform"
            ...
            <span className="text-white font-black text-xs">BV</span>
          </div>
        ...
        <div className="flex items-center gap-5">
          {["Privacy Policy", "Contact"].map((item) => (
            <a key={item} href="#" className="text-xs tracking-widest uppercase transition-colors duration-200"
      ...
      <div className="pt-6 text-center text-xs" style={{ borderTop: "1px solid rgba(255,255,255,0.06)", color: "rgba(255,255,255,0.25)" }}>
        © Blindfold Villa 2026 — Created by Jalaj Hasija
      </div>
    </div>
  </footer>
);
