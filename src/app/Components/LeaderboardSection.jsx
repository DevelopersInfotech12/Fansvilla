      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="relative w-full h-44 mb-16 overflow-hidden rounded-3xl">
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-10">
            ...
            <h2 className="font-black leading-tight text-white" style={{ fontFamily: "poppins: "'Poppins', 'system-ui', sans- serif", fontWeight: 900, textTransform: 'uppercase', fontSize: "clamp(2.2rem, 5vw, 3.5rem)" }}>
